...
if(NOT "${PELE_DIR}" STREQUAL "")
  message("PELE_DIR is ${PELE_DIR}")
else()
  message(FATAL_ERROR "You need to set the PELE_DIR variable. CMake will exit." )
endif()
...
set(CTEST_SOURCE_DIRECTORY "${PELE_DIR}")
set(CTEST_BINARY_DIRECTORY "${PELE_DIR}/build")
