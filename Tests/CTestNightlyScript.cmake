...
if(NOT "${PELELMEX_DIR}" STREQUAL "")
  message("PELELMEX_DIR is ${PELELMEX_DIR}")
else()
  message(FATAL_ERROR "You need to set the PELELMEX_DIR variable. CMake will exit." )
endif()
...
set(CTEST_SOURCE_DIRECTORY "${PELELMEX_DIR}")
set(CTEST_BINARY_DIRECTORY "${PELELMEX_DIR}/build")
