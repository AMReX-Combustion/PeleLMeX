  ...
  if (NOT (TARGET ${pele_physics_lib_name}))
    ...
    target_sources(${pele_physics_lib_name}
      PRIVATE
        ...
        ${PELE_PHYSICS_UTILITY_DIR}/TurbForcing/TurbForcing.cpp
        ${PELE_PHYSICS_UTILITY_DIR}/TurbForcing/TurbForcing.H
        ${PELE_PHYSICS_UTILITY_DIR}/TurbForcing/MersenneTwister.cpp
    ...
    if(PELE_PHYSICS_ENABLE_SPRAY)
       ...
       target_compile_definitions(${pele_physics_lib_name} PUBLIC SPRAY_GCM PELE_PHYSICS_SPRAY_GCM)
    ...
    target_link_libraries(${pele_physics_lib_name} PUBLIC AMReX-Hydro::amrex_hydro_api AMReX::amrex)
