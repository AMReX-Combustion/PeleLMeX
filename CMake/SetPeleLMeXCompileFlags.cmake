list(APPEND PELELMEX_CXX_FLAGS "-Wall" "-Wextra" "-pedantic" "-Wno-unused-function")
if(CMAKE_CXX_COMPILER_ID MATCHES "^(GNU|Clang|AppleClang)$")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 7.0)
    list(APPEND PELELMEX_CXX_FLAGS "-faligned-new"
                                "-Wunreachable-code"
                                "-Wnull-dereference"
                                "-Wfloat-conversion"
                                "-Wshadow"
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "^(Clang|AppleClang)$")
      list(APPEND PELELMEX_CXX_FLAGS "-Wno-pass-failed" "-Wno-c++17-extensions")
      if((CMAKE_CXX_COMPILER_ID STREQUAL "Clang") AND PELELMEX_ENABLE_FPE_TRAP_FOR_TESTS)
        list(APPEND PELELMEX_CXX_FLAGS "-ffp-exception-behavior=maytrap")
      endif()
    endif()
  endif()
endif()
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "Intel")
  list(APPEND PELELMEX_CXX_FLAGS "-diag-disable:11074,11076,10397,15335")
endif()
if(CMAKE_CXX_COMPILER_ID STREQUAL "IntelLLVM")
  list(APPEND PELELMEX_CXX_FLAGS "-Wno-sign-compare"
                              "-Wno-unused-parameter"
                              "-Wno-unused-variable")
endif()

separate_arguments(PELELMEX_CXX_FLAGS)
target_compile_options(${pelelmex_lib_name} PUBLIC $<$<COMPILE_LANGUAGE:CXX>:${PELELMEX_CXX_FLAGS}>)

# Use flags to avoid warnings from certain files
if((NOT PELELMEX_ENABLE_CUDA) AND (CMAKE_CXX_COMPILER_ID MATCHES "^(GNU|Clang|AppleClang)$"))
