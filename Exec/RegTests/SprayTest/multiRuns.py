...
def multiRun(args):
    ...
    for box in bsizes:
        ...
        first_params = "amr.max_step = {} ".format(iter_2)
        ...
        second_params = "amr.max_step = {} ".format(iter_2)
        second_params += "amr.restart = {}/{}_chk0000{} ".format(args.test_name, box, iter_1)
        second_params += "amr.check_int = -1 "
